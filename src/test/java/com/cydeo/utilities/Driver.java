...
public class Driver {
    ...
    /*
    We make the WebDriver private, because we want to limit access from outside the class
     */
    ...
    - If an instance doesn't exist, it will crate first, and then it will always return same instance.
     */
